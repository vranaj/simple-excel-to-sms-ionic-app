...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, androidPermissions, sms) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.sendSmsToSelectedNumber();
            _this.checkSimPermission();
        });
    };
    AppComponent.prototype.sendSmsToSelectedNumber = function () {
        var _this = this;
        this.androidPermissions.checkPermission(this.androidPermissions.PERMISSION.SEND_SMS).then(function (result) {
    ...
    AppComponent.prototype.checkSimPermission = function () {
        var _this = this;
        this.androidPermissions.checkPermission(this.androidPermissions.PERMISSION.READ_PHONE_STATE).then(function (result) {
            if (result.hasPermission) {
                // this.sms.send('0776621206', 'message1');
    ...
    AppComponent.ctorParameters = function () { return [
        ...
        { type: _ionic_native_sms_ngx__WEBPACK_IMPORTED_MODULE_6__["SMS"] }
    ]; };
...
module.exports = __webpack_require__(/*! C:\New folder\simple-excel-to-sms-ionic-app\src\main.ts */"./src/main.ts");
